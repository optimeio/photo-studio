        ...
        <div className="w-full sidebar-container lg:border-l border-[#12100E]/10 lg:pl-20 pt-4">
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-8 lg:gap-10">
            <div className="sidebar-info">
              ...
              <p className="text-[#12100E] font-serif text-sm md:text-2xl mb-1 md:mb-2">New York · London</p>
            ...
            <div className="sidebar-info">
              ...
              <a href="mailto:hello@lumacraft.com" className="text-[#12100E] font-serif text-sm md:text-2xl hover:text-[#C5A059] transition-colors break-all">hello@lumacraft.com</a>
            </div>
            ...
            <div className="sidebar-info">
              ...
              <p className="text-[#12100E] font-serif text-sm md:text-2xl">+1 (555) 987-6543</p>
            </div>
            ...
            <div className="sidebar-info">
              ...
              <a href="https://wa.me/1555987654" target="_blank" rel="noopener noreferrer" className="text-[#12100E] font-serif text-sm md:text-2xl hover:text-[#C5A059] transition-colors">+1 (555) 987-6543</a>
            </div>
            ...
            <div className="sidebar-info col-span-2 lg:col-span-1">
              ...
              <a href="#" className="text-[#12100E] font-serif text-sm md:text-2xl hover:text-[#C5A059] transition-colors">@lumacraftphoto</a>
            </div>
          </div>
        </div>
