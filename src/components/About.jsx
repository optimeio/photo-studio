        ...
        <div className="w-full about-text-container">
          ...
          <div className="about-text relative mb-12 pl-6 md:pl-10">
            ...
            <p className="text-[#201D19]/80 mb-6 leading-relaxed text-lg font-light">
              At LumaCraft Photography, we believe that photography is more than just taking pictures. It's about freezing genuine feelings, unguarded smiles, and the invisible connections between people.
            </p>
            <p className="text-[#201D19]/80 mb-6 leading-relaxed text-lg font-light">
