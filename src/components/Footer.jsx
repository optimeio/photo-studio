      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="footer-col opacity-0">
            ...
            <ul className="flex flex-col gap-5">
              <li className="flex items-start gap-4">
                ...
                <span className="text-[#FFFDF8]/70 text-base leading-relaxed">123 Studio Lane,<br/>New York, NY 10001</span>
              </li>
              <li className="flex items-center gap-4">
                <Phone className="w-5 h-5 text-[#C5A059] shrink-0" />
                <span className="text-[#FFFDF8]/70 text-base">+1 (555) 987-6543</span>
              </li>
              <li className="flex items-center gap-4">
                <Mail className="w-5 h-5 text-[#C5A059] shrink-0" />
                <a href="mailto:hello@lumacraft.com" className="text-[#FFFDF8]/70 hover:text-[#C5A059] text-base transition-colors break-all">hello@lumacraft.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-col opacity-0 border-t border-[#FFFDF8]/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#FFFDF8]/40 text-xs text-center md:text-left tracking-wide">
            &copy; {new Date().getFullYear()} LumaCraft Photography. All Rights Reserved.
          </p>
